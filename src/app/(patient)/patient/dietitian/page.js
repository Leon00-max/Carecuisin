...
const SPECIALTIES = ['Diabetes nutrition', 'Hypertension care', 'Weight management', 'Kidney-conscious planning'];
    ...
    <div className="mx-auto max-w-4xl space-y-6 pb-4">
      ...
      <section className="card-medical rounded-2xl border-surface-100 p-5">
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h1 className="truncate text-2xl font-black text-surface-900">Dr. Ambe Florence</h1>
              <CheckCircle size={18} className="shrink-0 text-success" />
            </div>
            <p className="mt-1 text-sm font-semibold text-surface-500">Verified Dietitian</p>
            <p className="mt-2 flex items-center gap-1.5 text-xs text-surface-500">
              <MapPin size={14} className="text-primary-500" />
              Buea Regional Care Network
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-3">
          ...
          <Stat icon={Stethoscope} label="Patients" value="142" />
          <Stat icon={Clock} label="Response" value="Under 10 min" />
        </div>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <div className="card-medical rounded-2xl border-surface-100 p-5">
          ...
          <h2 className="mt-4 text-sm font-black text-surface-900">Availability</h2>
          <p className="mt-2 text-sm leading-relaxed text-surface-500">
            Available today for meal questions and plan review support.
          </p>
        </div>

        <div className="card-medical rounded-2xl border-surface-100 p-5">
          <ShieldCheck size={22} className="text-success" />
          <h2 className="mt-4 text-sm font-black text-surface-900">Verification</h2>
          <p className="mt-2 text-sm leading-relaxed text-surface-500">
            License reviewed by CareCuisin admin operations.
          </p>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <a href="tel:+237650000000" className="btn-outline flex items-center justify-center gap-2 rounded-2xl bg-white">
          <Phone size={17} />
          Call
        </a>
      </section>
